...
const DETECTION_EVENT_TO_SECURITY_ACTION_TYPE_MAP: Readonly<Record<string, SecurityActionType>> = {
  ...
  GUILD_UPDATE: SecurityActionType.GUILD_CONFIGURATION_UPDATE,
  GUILD_SETTINGS_UPDATE: SecurityActionType.GUILD_CONFIGURATION_UPDATE,
  GUILD_CONFIGURATION_UPDATE: SecurityActionType.GUILD_CONFIGURATION_UPDATE,
  GUILD_FEATURES_UPDATE: SecurityActionType.GUILD_CONFIGURATION_UPDATE,
  GUILD_LOCALE_UPDATE: SecurityActionType.GUILD_CONFIGURATION_UPDATE,
  GUILD_COMMUNITY_UPDATE: SecurityActionType.GUILD_CONFIGURATION_UPDATE,
  GUILD_INTEGRATIONS_UPDATE: SecurityActionType.INTEGRATION_MANAGEMENT,
  INTEGRATION_CREATE: SecurityActionType.INTEGRATION_MANAGEMENT,
  INTEGRATION_UPDATE: SecurityActionType.INTEGRATION_MANAGEMENT,
  INTEGRATION_DELETE: SecurityActionType.INTEGRATION_MANAGEMENT,
  APPLICATION_INSTALL: SecurityActionType.INTEGRATION_MANAGEMENT,
  APPLICATION_REMOVE: SecurityActionType.INTEGRATION_MANAGEMENT,
  APPLICATION_CONFIGURATION_UPDATE: SecurityActionType.INTEGRATION_MANAGEMENT,
  APPLICATION_CONFIG_UPDATE: SecurityActionType.INTEGRATION_MANAGEMENT,
};
